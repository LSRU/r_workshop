...
Replace `R base` functions by the [**hadleyverse**](https://barryrowlingson.github.io/hadleyverse/).
...
- Practical: [online](practical_day1-beginner.html) and [pdf](practical_day1-beginner.pdf)
...
- practice on normalisation of qPCR (or any) data

#### June 2nd afternoon, intermediate level

##### small presentation ~ 30 minutes - `dplyr`

- Slides: [online](lecture_day1-intermediate.html)

##### microarray hands-on

- Practical: [online](practical_day1-intermediate.html) 
